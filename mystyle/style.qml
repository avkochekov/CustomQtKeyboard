...
KeyboardStyle {
    ...
    readonly property string resourcePrefix: "qrc:/QtQuick/VirtualKeyboard/Styles/mystyle/"

    readonly property string keyboardBackgroundColor: "#001F24"
    readonly property int keyRadius: 0
    readonly property string keyBackgroundColor: "#002B32"
    readonly property string keyTextColor: "#FFFFFF"

    readonly property string backspaceKeyBackgroundColor: "#5B797E"
    readonly property string languageKeyBackgroundColor: "#5B797E"
    readonly property string enterKeyBackgroundColor: "#3B7E82"
    readonly property string hideKeyBackgroundColor: "#5B797E"
    readonly property string shiftKeyBackgroundColor: "#5B797E"
    readonly property string capsLockKeyBackgroundColor: "#3B7E82"
    readonly property string spaceKeyBackgroundColor: "#002B32"
    readonly property string spaceKeyTextColor: "#FFFFFF"
    readonly property string symbolKeyBackgroundColor: "#5B797E"
    readonly property string symbolKeyTextColor: "#FFFFFF"
    readonly property string modeKeyBackgroundColor: "#5B797E"
    readonly property string modeKeyTextColor: "#FFFFFF"

    readonly property string languageListTextColor: "#FFFFFF"
    readonly property int languageListBorderWidth: 2
    readonly property string languageListBorderColor: "#001F24"
    readonly property string languageListBackgroundColor: "#5B797E"

    readonly property string backspaceKeyIconSource: resourcePrefix + "images/backspace.svg"
    readonly property string languageKeyIconSource: resourcePrefix + "images/globe.svg"
    readonly property string enterKeyIconSource: resourcePrefix + "images/enter.svg"
    readonly property string searchKeyIconSource: resourcePrefix + "images/search.svg"
    readonly property string checkKeyIconSource: resourcePrefix + "images/check.svg"
    readonly property string hideKeyIconSource: resourcePrefix + "images/hide.svg"
    readonly property string shiftKeyIconSource: resourcePrefix + "images/shift.svg"
    readonly property string shiftActiveKeyIconSource: resourcePrefix + "images/shift-active.svg"
    readonly property string shiftLockedKeyIconSource: resourcePrefix + "images/shift-locked.svg"
    readonly property string selectionHandleIconSource: resourcePrefix + "images/selectionhandle.svg"
    readonly property string textmodeIconSource: resourcePrefix + "images/textmode.svg"
    readonly property string handwritingIconSource: resourcePrefix + "images/handwriting.svg"
    ...
    keyboardDesignWidth: 2560
    keyboardDesignHeight: 800
    keyboardRelativeLeftMargin: 220 / keyboardDesignWidth
    keyboardRelativeRightMargin: 220 / keyboardDesignWidth
    keyboardRelativeTopMargin: 35 / keyboardDesignHeight
    keyboardRelativeBottomMargin: 35 / keyboardDesignHeight
    ...
    backspaceKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            radius: keyRadius
            color: backspaceKeyBackgroundColor
    ...
    languageKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            radius: keyRadius
            color: languageKeyBackgroundColor
        ...
        Rectangle {
            ...
            Image {
                ...
                source: {
                    ...
                    case EnterKeyAction.Next:
                    case EnterKeyAction.Done:
                        return checkKeyIconSource
                    case EnterKeyAction.Search:
                        return searchKeyIconSource
                    default:
                        return enterKeyIconSource
                    }
                }
            }
            Text {
        ...
        Rectangle {
            ...
            states: [
                State {
                    ...
                    //     color: capsLockKeyBackgroundColor
                    // }
                    PropertyChanges {
                        target: shiftKeyIcon
                        source: shiftLockedKeyIconSource
                    }
                },
                State {
                    name: "shiftActive"
                    ...
                    PropertyChanges {
                        target: shiftKeyIcon
                        source: shiftActiveKeyIconSource
                    }
                }
            ]
        }
    ...
    symbolKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            radius: keyRadius
            color: symbolKeyBackgroundColor
            anchors.fill: symbolKeyPanel
            anchors.margins: keyBackgroundMargin
            Text {
                id: symbolKeyText
                text: control.displayText
                color: symbolKeyTextColor
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
                anchors.fill: parent
    ...
    modeKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            radius: keyRadius
            color: modeKeyBackgroundColor
            anchors.fill: modeKeyPanel
            anchors.margins: keyBackgroundMargin
            Text {
                id: modeKeyText
                text: control.displayText
                color: modeKeyTextColor
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
                anchors.fill: parent
                anchors.margins: keyContentMargin
    ...
    //             smooth: false
    //             source: keyboard.handwritingMode ? textmodeIconSource : handwritingIconSource
    //         }
    //     }
    //     states: [
    //         State {
    ...
    //             text: {
    //                 console.log("InputContext.inputEngine.inputMode: " + InputContext.inputEngine.inputMode)
    ...
    languageListBackground: Rectangle {
        color: languageListBackgroundColor
        border {
            width: languageListBorderWidth
            color: languageListBorderColor
        }
    }
    ...
    //     sourceSize.width: 20
    //     source: selectionHandleIconSource
    // }
